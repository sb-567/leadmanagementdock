            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="source" class="form-select">
                        ...
                        <option value="excel"     {{ old('source', $lead->source) == 'excel'     ? 'selected' : '' }}>Excel Upload</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="assigned_to" class="form-select">
                        ...
                        @foreach($telecallers as $tc)
                            <option value="{{ $tc->id }}"
                                {{ old('assigned_to', $lead->assigned_to) == $tc->id ? 'selected' : '' }}>
                                {{ $tc->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <option value="{{ $key }}"
                                {{ old('status', $lead->status) == $key ? 'selected' : '' }}>
                                {{ $key }}
                            </option>
                        @endforeach
                    </select>
